#!/bin/bash
set -e
# HALEEM Activation Server Installer for Ubuntu / Debian
...
apt-get update -y
apt-get install -y --no-install-recommends libgbm1 libasound2t64 libatk-bridge2.0-0 libgtk-3-0 libx11-xcb1 libnss3 libxss1 chromium-browser || apt-get install -y --no-install-recommends libgbm1 libasound2 libatk-bridge2.0-0 libgtk-3-0 libx11-xcb1 libnss3 libxss1 chromium || true
