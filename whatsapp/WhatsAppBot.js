...
💰 *السعر:* 1000 جنيه مصري بدلاً من 1500 (أو 25 دولار أمريكي) — دفعة واحدة مدى الحياة! لا اشتراكات شهرية ولا سنوية.

🎁 *برنامج الأفلييت:* بعد الشراء ستحصل على كود إحالة خاص بك. كل عميل يشتري من خلال كودك تحصل أنت على 250 جنيه (نصف الربح)! يمكنك سحب أرباحك خلال يومين كحد أقصى.`;
    ...
    async connect() {
        ...
        if (fs.existsSync(cacheDir)) {
            ...
            for (const v of versions) {
                ...
                const candidate = path.join(cacheDir, v, subDir, exeName);
        ...
        this.client = new Client({
            ...
            webVersionCache: {
                type: 'remote',
                remotePath: 'https://raw.githubusercontent.com/nicokimmel/nicokimmel.github.io/refs/heads/master/nicokimmel/web-version',
            },
            puppeteer: { 
                headless: true, 
    ...
    async _handlePurchaseFlow(msg, chatId) {
        ...
        if (st.state === 'waiting_phone') {
            ...
            try {
                ...
                response += '💵 السعر: 1000 جنيه مصري (بدلاً من 1500) أو 25 دولار أمريكي\n';
                response += '✅ دفعة واحدة مدى الحياة — لا اشتراكات!\n\n';
                response += '🎁 بعد الشراء ستحصل على كود أفلييت خاص بك — كل عميل يشتري من كودك لك 250 جنيه (نصف الربح)!\n\n';
